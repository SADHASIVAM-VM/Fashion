...
const Kids = () => {
    return (
        <div className="">
          ...
          <h1 className='text-2xl font-bold items-center my-10 border-b-8 border-r-8 border-xl rounded-s-lg border-gray-900 inline-block bg-[#00ed46] p-2 shadow-xl text-gray-800 '>KID'S COLLECTIONS</h1>
          </div>
         <div className="flex flex-col md:flex-row flex-wrap gap-2 justify-center items-center md:px-20">
         {
            all_product.filter((itms)=> itms.category === "kid").map((itms)=>(
